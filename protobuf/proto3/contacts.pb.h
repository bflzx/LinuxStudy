...
template<> ::contacts2::Phone* Arena::CreateMaybeMessage<::contacts2::Phone>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace contacts2 {
...
class Phone final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:contacts2.Phone) */ {
 public:
  ...
  // .contacts2.Phone.PhoneType type = 2;
  void clear_type();
  ::contacts2::Phone_PhoneType type() const;
  void set_type(::contacts2::Phone_PhoneType value);
  private:
  ::contacts2::Phone_PhoneType _internal_type() const;
  void _internal_set_type(::contacts2::Phone_PhoneType value);
  public:

  // @@protoc_insertion_point(class_scope:contacts2.Phone)
 private:
  class _Internal;
...
class PeopleInfo final :
 ...
 public:
  ...
  // repeated .contacts2.Phone phone = 3;
  int phone_size() const;
  private:
  int _internal_phone_size() const;
  public:
  void clear_phone();
  ::contacts2::Phone* mutable_phone(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts2::Phone >*
      mutable_phone();
  private:
  const ::contacts2::Phone& _internal_phone(int index) const;
  ::contacts2::Phone* _internal_add_phone();
  public:
  const ::contacts2::Phone& phone(int index) const;
  ::contacts2::Phone* add_phone();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts2::Phone >&
      phone() const;
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts2::Phone > phone_;
...
inline const std::string& Phone::number() const {
  // @@protoc_insertion_point(field_get:contacts2.Phone.number)
...
void Phone::set_number(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.number_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contacts2.Phone.number)
}
inline std::string* Phone::mutable_number() {
  std::string* _s = _internal_mutable_number();
  // @@protoc_insertion_point(field_mutable:contacts2.Phone.number)
  return _s;
}
...
inline std::string* Phone::release_number() {
  // @@protoc_insertion_point(field_release:contacts2.Phone.number)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:contacts2.Phone.number)
}
...
inline ::contacts2::Phone_PhoneType Phone::_internal_type() const {
  return static_cast< ::contacts2::Phone_PhoneType >(_impl_.type_);
}
inline ::contacts2::Phone_PhoneType Phone::type() const {
  // @@protoc_insertion_point(field_get:contacts2.Phone.type)
  return _internal_type();
}
inline void Phone::_internal_set_type(::contacts2::Phone_PhoneType value) {
  
  _impl_.type_ = value;
}
inline void Phone::set_type(::contacts2::Phone_PhoneType value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:contacts2.Phone.type)
}
...
inline ::contacts2::Phone* PeopleInfo::mutable_phone(int index) {
  // @@protoc_insertion_point(field_mutable:contacts2.PeopleInfo.phone)
  return _impl_.phone_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts2::Phone >*
PeopleInfo::mutable_phone() {
  // @@protoc_insertion_point(field_mutable_list:contacts2.PeopleInfo.phone)
  return &_impl_.phone_;
}
inline const ::contacts2::Phone& PeopleInfo::_internal_phone(int index) const {
  return _impl_.phone_.Get(index);
}
inline const ::contacts2::Phone& PeopleInfo::phone(int index) const {
  // @@protoc_insertion_point(field_get:contacts2.PeopleInfo.phone)
  return _internal_phone(index);
}
inline ::contacts2::Phone* PeopleInfo::_internal_add_phone() {
  return _impl_.phone_.Add();
}
inline ::contacts2::Phone* PeopleInfo::add_phone() {
  ::contacts2::Phone* _add = _internal_add_phone();
  // @@protoc_insertion_point(field_add:contacts2.PeopleInfo.phone)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts2::Phone >&
...
template <> struct is_proto_enum< ::contacts2::Phone_PhoneType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::contacts2::Phone_PhoneType>() {
  return ::contacts2::Phone_PhoneType_descriptor();
}
