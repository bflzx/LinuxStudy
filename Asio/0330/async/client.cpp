...
#define MEM_FN1(x,y) std::bind(&self_type::x,shared_from_this(),_1)
#define MEM_FN2(x,y,z) std::bind(&self_type::x,shared_from_this(),_1,_2)
...
int main(int argc, char* argv[]) {
    ...
    char* messages[] = { "John says hi", "so does James", "Lucygot home", 0 };
